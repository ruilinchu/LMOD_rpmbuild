...
./configure --prefix=%{INSTALL_DIR} --enable-shared=yes CFLAGS='-fPIC' --enable-mpi --enable-openmp --enable-threads CFLAGS=-march=native CPPFLAGS=-march=native --enable-float
make -j8
make install
